...
export const Login = () => {
    const [email, setEmail] = useState("steve1@stevebrownlee.com")
    ...
    const handleLogin = (e) => {
        ...
        fetch(`http://localhost:8000/login`, {
            ...
            .then(authInfo => {
                if (authInfo.valid) {
                    localStorage.setItem("capsule_token", JSON.stringify(authInfo))
                    navigate("/")
                } else {
        ...
        <main className="container--login">
            ...
            <section>
                <form className="form--login" onSubmit={handleLogin}>
                    <h1 className="text-4xl mt-7 mb-3">Time Capsule Platform</h1>
